// Opções inline, ou seja botões que disparam ações no corpo do texto
...
bot.start(async ctx => {
    ...
    await ctx.reply(`A contagem atualz esté em ${contagem}`, botoes)
})
